...
import io.github.oleksivio.telegram.bot.api.annotations.filter.composite.StickerFilter
...
@Component
class StickerFilterParser : FilterParser<StickerFilter, Sticker> {
    ...
    override fun createChecker(annotation: StickerFilter, finder: Finder): Validator<Sticker> {
        val unionExtractValidator = UnionExtractValidator<Sticker>()
