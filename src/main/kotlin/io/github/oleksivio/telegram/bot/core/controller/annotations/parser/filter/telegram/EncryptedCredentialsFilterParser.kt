...
@Component
class EncryptedCredentialsFilterParser : FilterParser<EncryptedCredentialsFilter, EncryptedCredentials> {
    ...
    override fun createChecker(annotation: EncryptedCredentialsFilter, finder: Finder): Validator<EncryptedCredentials> {
        val unionExtractValidator = UnionExtractValidator<EncryptedCredentials>()
