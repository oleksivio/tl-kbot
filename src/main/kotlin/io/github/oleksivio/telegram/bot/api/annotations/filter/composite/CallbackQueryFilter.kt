...
annotation class CallbackQueryFilter(
        ...
        val chatInstance: StringFilter = StringFilter(status = AnnotationState.OFF),
        val data: StringFilter = StringFilter(status = AnnotationState.OFF),
        val gameShortName: StringFilter = StringFilter(status = AnnotationState.OFF)
)
