...
import io.github.oleksivio.telegram.bot.api.model.objects.inline.queryresult.InlineQueryResult
 ...
 */
class AnswerInlineQuery(actionNetworker: ActionNetworker) : RunnableAction<Boolean>(METHOD, actionNetworker) {
    /**
     * inline_query_id String Yes Unique identifier for the answered query
     */
    @JsonProperty("inline_query_id")
    var inlineQueryId: String? = null
    /**
     * results Array of InlineQueryResult Yes A JSON-serialized array of results for the inline query
     */
    @JsonProperty("results")
    var inlineQueryResults = ArrayList<InlineQueryResult>()
    /**
    ...
    companion object {
        private const val METHOD = "answerInlineQuery"
    }
