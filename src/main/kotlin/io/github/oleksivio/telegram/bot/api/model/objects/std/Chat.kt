...
data class Chat(
         ...
         * To setup filter:
         *
         * @see Type type type String Type of chat, can be either “private”, “group”, “supergroup” or “channel”
         */
        @JsonProperty("type")
         ...
         * To setup filter:
         *
         * @see StringFilter title title String Optional. Title, for supergroups, channels and group chats
         */
        @JsonProperty("title")
         ...
         * To setup filter:
         *
         * @see StringFilter username username String Optional. Username, for private chats, supergroups and channels if
         * available
         */
         ...
         * To setup filter:
         *
         * @see StringFilter firstName first_name String Optional. First name of the other party in a private chat
         */
         ...
         * To setup filter:
         *
         * @see StringFilter lastName last_name String Optional. Last name of the other party in a private chat
         */
         ...
         * To setup filter:
         *
         * @see BooleanFilter allMembersAreAdministrators all_members_are_administrators Boolean Optional. True if a group has
