...
annotation class VenueFilter(
        ...
        val address: StringFilter = StringFilter(status = AnnotationState.OFF),
        val foursquareId: NotNullFilter = NotNullFilter(status = AnnotationState.OFF),
        val foursquareType: StringFilter = StringFilter(status = AnnotationState.OFF)
)
