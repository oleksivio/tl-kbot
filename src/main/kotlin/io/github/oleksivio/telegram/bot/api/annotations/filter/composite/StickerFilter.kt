...
annotation class StickerFilter(
        ...
        val maskPosition: MaskPositionFilter = MaskPositionFilter(status = AnnotationState.OFF),
        ...
        val emoji: StringFilter = StringFilter(status = AnnotationState.OFF),
        val setName: StringFilter = StringFilter(status = AnnotationState.OFF),
