...
import io.github.oleksivio.telegram.bot.api.annotations.filter.composite.ShippingAddressFilter
...
@Component
class ShippingAddressFilterParser : FilterParser<ShippingAddressFilter, ShippingAddress> {
    ...
    override fun createChecker(annotation: ShippingAddressFilter, finder: Finder): Validator<ShippingAddress> {
        val unionExtractValidator = UnionExtractValidator<ShippingAddress>()
