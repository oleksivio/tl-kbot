 ...
 */
class AddStickerFileToSet(fileNetworker: FileNetworker) : UploadFile<Boolean>(METHOD, fileNetworker) {
    ...
    fun setContainMasks(value: Boolean) {
        putBool(CONTAINS_MASKS_KEY, value)
    }
