...
annotation class OrderInfoFilter(
        ...
        val name: StringFilter = StringFilter(status = AnnotationState.OFF),
        ...
        val shippingAddress: ShippingAddressFilter = ShippingAddressFilter(status = AnnotationState.OFF)
)
