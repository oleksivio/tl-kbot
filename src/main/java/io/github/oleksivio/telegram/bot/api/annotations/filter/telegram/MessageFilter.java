...
public @interface MessageFilter {
    ...
    IncludeMessageFilter replyToMessage() default @IncludeMessageFilter(status = AnnotationState.OFF);
    ...
    IncludeMessageFilter pinnedMessage() default @IncludeMessageFilter(status = AnnotationState.OFF);
