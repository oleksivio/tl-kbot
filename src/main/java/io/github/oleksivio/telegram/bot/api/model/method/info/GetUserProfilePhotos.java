...
import io.github.oleksivio.telegram.bot.core.model.responses.UserProfilePhotosResponse;
...
public class GetUserProfilePhotos extends RunnableAction<UserProfilePhotos> {
    ...
    @Override
    public GetUserProfilePhotos setNetworkErrorListener(NetworkError onNetworkError) {
