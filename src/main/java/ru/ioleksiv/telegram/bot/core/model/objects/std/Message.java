...
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.Audio;
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.Document;
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.MessageEntity;
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.PhotoSize;
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.Video;
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.VideoNote;
import ru.ioleksiv.telegram.bot.core.model.objects.std.files.Voice;
import ru.ioleksiv.telegram.bot.core.model.objects.std.game.Animation;
import ru.ioleksiv.telegram.bot.core.model.objects.std.game.Game;
import ru.ioleksiv.telegram.bot.core.model.objects.std.sticker.Sticker;
