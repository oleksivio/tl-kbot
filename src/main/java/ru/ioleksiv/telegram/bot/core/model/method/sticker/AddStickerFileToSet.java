...
import ru.ioleksiv.telegram.bot.core.model.method.interfaces.UploadFile;
import ru.ioleksiv.telegram.bot.core.model.objects.std.sticker.MaskPosition;
...
public class AddStickerFileToSet extends UploadFile<Boolean> {
    ...
    public AddStickerFileToSet(Networker networker) {
