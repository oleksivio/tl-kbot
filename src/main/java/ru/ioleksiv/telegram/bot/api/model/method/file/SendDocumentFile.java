 ...
 */
public class SendDocumentFile extends UploadMediaFile {
    ...
    public SendDocumentFile(FileNetworker fileNetworker) {
    ...
    @Override
    public SendDocumentFile setNetworkErrorListener(NetworkError onNetworkError) {
