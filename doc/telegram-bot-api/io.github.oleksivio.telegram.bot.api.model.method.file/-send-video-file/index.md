[telegram-bot-api](../../index.md) / [io.github.oleksivio.telegram.bot.api.model.method.file](../index.md) / [SendVideoFile](./index.md)

# SendVideoFile

`data class SendVideoFile : UploadMediaFile`
...
| [video](video.md) | `val video: FileSystemResource`<br>video  String Video to send. Pass a file_id as String to send a video that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a video from the Internet |
